...
import styles from '../styles/Rejectedcampaign.module.css'; // use same CSS module
...
function Rejectedcampaign() {
  ...
  const viewallcampaign = async () => {
    try {
      ...
      const rejectedCampaigns = response.filter(camp => camp.status === "rejected");
      setdata(rejectedCampaigns);
    } catch (error) {
      console.log(error);
    }
  };
  ...
  return (
    <div className={styles.pageWrapper}>
      ...
      <div className={styles.contentWrapper}>
        <h1 className={styles.pageTitle}>Rejected Campaigns</h1>
